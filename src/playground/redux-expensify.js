...
const expenseThree= store.dispatch(addExpense({ description: "Coke", amount: 200, createdAt: -1000 }));
// const expenseThree = store.dispatch(addExpense({ description: "Pie", amount: 600 }));
